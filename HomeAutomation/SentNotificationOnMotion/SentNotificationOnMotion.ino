...
const char* eventName = "Motion detected.";                       // the event to trigger at ifttt.com
const char* apikey    = "lDvUwWO9_qFNU5Y4tDyL0P7h_5Yd_fHb9w3labZ5p3k";                          // your ifttt.com api key
const byte  port      = 80;   
